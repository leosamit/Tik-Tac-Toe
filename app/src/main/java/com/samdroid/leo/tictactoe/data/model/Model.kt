package com.samdroid.leo.tictactoe.data.model

import android.util.Log
import com.samdroid.leo.tictactoe.utils.array2d
...
class Board {
    ...
    fun hasWon(thePlayer: Seed): Boolean {
        ...
        for (row in 0 until ROW) {
            ...
            Log.d("TestTestWTF", pattern.toString())
        ...
        winningPatterns
            ...
            .forEach {
                Log.d("TestTest", (pattern).toString())
                winLine = it
                return true
